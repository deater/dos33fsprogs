...
;  80 bytes -- the size of fire_tiny.s
...
; urgh FAC is 9d-a2
; should be load at A8-e8 instead?
...
no_change:
	...
	; clever lookup table, only check bottom 3 bits (so 8 entries)
	; 0000/1000 (0/8) ->  0	black/brown -> black
	; 0001/1001 (1/9) -> 11 red/orange  -> pink
	; 0010/1010 (2/10) -> 0 blue/grey   -> black
	; 0011/1011 (3/11) ->10 purple/pink -> grey
	; 0100/1100 (4/12) -> 0 green/green -> black (can't happen)
	; 0101/1101 (5/13) -> 9 grey/yellow -> orange
	; 0110/1110 (6/14) -> 0 lblue/aqua  -> black (can't happen)
	; 0111/1111 (7/15) ->13 llblue/white-> yellow

	; ideally somewhere in ROM patterh 00/bb/00/aa/XX/99/xx/dd
