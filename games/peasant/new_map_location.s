...
.byte LOCATION_EMPTY		; LOCATION_TROGDOR_OUTER2=	31
.byte LOCATION_EMPTY		; LOCATION_TROGDOR_OUTER3=	32
.byte LOCATION_EMPTY		; LOCATION_INSIDE_INN_NIGHT=	33
.byte LOCATION_EMPTY		; LOCATION_EMPTY	=	34
...
.byte LOCATION_EMPTY		; LOCATION_TROGDOR_OUTER2=	31
.byte LOCATION_EMPTY		; LOCATION_TROGDOR_OUTER3=	32
.byte LOCATION_OUTSIDE_INN	; LOCATION_INSIDE_INN_NIGHT=	33
.byte LOCATION_EMPTY		; LOCATION_EMPTY	=	34
...
.byte LOCATION_EMPTY		; LOCATION_MAP		=	29
.byte LOCATION_EMPTY		; LOCATION_CLIMB	=	30
.byte LOCATION_TROGDOR_LAIR	; LOCATION_TROGDOR_OUTER2=	31
.byte LOCATION_TROGDOR_LAIR	; LOCATION_TROGDOR_OUTER3=	32
.byte LOCATION_EMPTY		; LOCATION_INSIDE_INN_NIGHT=	33
.byte LOCATION_EMPTY		; LOCATION_EMPTY	=	34
...
.byte LOCATION_EMPTY		; LOCATION_MAP		=	29
.byte LOCATION_EMPTY		; LOCATION_CLIMB	=	30
.byte LOCATION_CLIFF_HEIGHTS	; LOCATION_TROGDOR_OUTER2=	31
.byte LOCATION_CLIFF_HEIGHTS	; LOCATION_TROGDOR_OUTER3=	32
.byte LOCATION_EMPTY		; LOCATION_INSIDE_INN_NIGHT=	33
.byte LOCATION_EMPTY		; LOCATION_EMPTY	=	34


location_to_file:
.byte LOAD_GARY			; LOCATION_POOR_GARY	=	0
.byte LOAD_KERREK1		; LOCATION_KERREK_1	=	1
.byte LOAD_WELL			; LOCATION_OLD_WELL	=	2
.byte LOAD_YELLOW_TREE		; LOCATION_YELLOW_TREE	=	3
.byte LOAD_WATERFALL		; LOCATION_WATERFALL	=	4

.byte LOAD_HAYSTACK		; LOCATION_HAY_BALE	=	5
.byte LOAD_PUDDLE		; LOCATION_MUD_PUDDLE	=	6
.byte LOAD_BROTHERS		; LOCATION_ARCHERY	=	7
.byte LOAD_RIVER		; LOCATION_RIVER_STONE	=	8
.byte LOAD_KNIGHT		; LOCATION_MOUNTAIN_PASS=	9

.byte LOAD_JHONKA		; LOCATION_JHONKA_CAVE	=	10
.byte LOAD_COTTAGE		; LOCATION_YOUR_COTTAGE	=	11
.byte LOAD_LAKE_WEST		; LOCATION_LAKE_WEST	=	12
.byte LOAD_LAKE_EAST		; LOCATION_LAKE_EAST	=	13
.byte LOAD_OUTSIDE_INN		; LOCATION_OUTSIDE_INN	=	14

.byte LOAD_NED_COTTAGE		; LOCATION_OUTSIDE_NN	=	15
.byte LOAD_WAVY_TREE		; LOCATION_WAVY_TREE	=	16
.byte LOAD_KERREK2		; LOCATION_KERREK_2	=	17
.byte LOAD_LADY_COTTAGE		; LOCATION_OUTSIDE_LADY	=	18
.byte LOAD_BURNINATED_TREE	; LOCATION_BURN_TREES	= 	19
...
.byte LOAD_HIDDEN_GLEN		; LOCATION_HIDDEN_GLEN	=	24
.byte LOAD_INSIDE_LADY		; LOCATION_INSIDE_LADY	= 	25
.byte LOAD_INSIDE_NED		; LOCATION_INSIDE_NN	=	26
.byte LOAD_INSIDE_INN		; LOCATION_INSIDE_INN	=	27

.byte LOAD_ARCHERY		; LOCATION_ARCHERY_GAME	=	28
.byte LOAD_MAP			; LOCATION_MAP		=	29
.byte LOAD_CLIMB		; LOCATION_CLIMB	=	30
.byte LOAD_OUTER2		; LOCATION_TROGDOR_OUTER2=	31
.byte LOAD_OUTER3		; LOCATION_TROGDOR_OUTER3=	32
.byte LOAD_INSIDE_INN_NIGHT	; LOCATION_INSIDE_INN_NIGHT=	33
.byte LOAD_KERREK_FALL		; LOCATION_INSIDE_INN_NIGHT=	34
.byte LOCATION_EMPTY		; LOCATION_EMPTY	=	35
